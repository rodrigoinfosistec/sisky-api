    ...
    public partial class AddMultitenancy : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_company_modules", x => new { x.company_id, x.module_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_roles", x => new { x.user_id, x.company_id, x.role_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_permissions_module_id_slug",
                table: "permissions",
